$(function() {
  ...
  var tileTypes = [
    ...
    redPortalType = new TileType('redPortal', 0, 0, 204, 51, 0, "Red Portal - Can be used by red balls.", {image: $("#portal").attr("url"), logicFn: exportPortal}),
    bluePortalType = new TileType('bluePortal', 0,0, 0, 102, 204, "Blue Portal - Can be used by blue balls.", {image: $("#portal").attr("url"), logicFn: exportPortal}),
